...
class QuizActivity : AppCompatActivity(),View.OnClickListener {
    ...
    override fun onClick(view: View?) {
        ...
        binding.apply {
            btn0.setBackgroundColor(getColor(R.color.soft_pink))
            btn1.setBackgroundColor(getColor(R.color.soft_pink))
            btn2.setBackgroundColor(getColor(R.color.soft_pink))
            btn3.setBackgroundColor(getColor(R.color.soft_pink))
        }
